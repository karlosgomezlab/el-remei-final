                ...
                <div className="bg-gray-50 rounded-[3rem] border border-gray-100 shadow-2xl overflow-hidden min-h-[600px] flex flex-col md:flex-row">
                    ...
                    <div className="flex-1 p-8 md:p-12 bg-white relative min-w-0">
                        {isCheckingAuth ? (
                            ...
                            >
                                <div className="w-20 h-20 bg-orange-100 rounded-3xl flex items-center justify-center text-orange-500 transform rotate-6 border-4 border-white shadow-xl">
                                    <User className="w-10 h-10" />
                                </div>
                                <div className="max-w-xs">
                                    <h4 className="text-2xl font-black uppercase tracking-tight mb-2">Acceso Reservado</h4>
                                    <p className="text-gray-500 font-medium text-sm">Para reservar tu mesa personalizada, primero debes entrar en tu cuenta.</p>
                                </div>
                                <Link
                                    href="/cuenta"
                                    className="px-8 py-4 bg-gray-900 text-white rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-black transition-all shadow-xl flex items-center gap-2 group"
                                >
                                    Ir a mi cuenta
                                    <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                                </Link>
                                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest leading-relaxed">
                                    Es rápido y solo necesitas <br /> tu número de teléfono.
                                </p>
                            </motion.div>
                        ) : (
